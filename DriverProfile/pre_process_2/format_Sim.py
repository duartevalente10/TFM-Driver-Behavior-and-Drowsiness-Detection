...
# formatData(folder_path_sim_1,"sim_1_kss_filter_34")
# formatData(folder_path_sim_2,"sim_2_kss_filter_34")

# Merge two sim datasets

# load of df
sim1 = pd.read_csv('datasets/sim/sim_1_kss_filter_34.csv')
sim2 = pd.read_csv('datasets/sim/sim_2_kss_filter_34.csv')
